...

{
    ...
    {
        private readonly string _connectionString = @"Data Source=""C:\Users\Gebruiker\Downloads\Tussendatabase (1).db"";";//Verander dit naar de locatie van de database op jouw computer
        private readonly string _hoofdConnectionString = @"Data Source=""C:\Users\Gebruiker\Downloads\Hoofddatabase (3).db"";";//Verander dit naar de locatie van de database op jouw computer
